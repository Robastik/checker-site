  ...
  - type: FeaturedItemsSection
    ...
    items:
      - title: Надежность
        ...
        text: >
          Все решение полностью основано на глобальных сервисах Гугл и
          подвержено минимальному влиянию локальных проблем.
        image:
      ...
      - type: FeaturedItem
        ...
        text: >
          ...
          неограниченного количества людей из любой локации, как из браузера,
          так и со специальным ПО (Excel, Power BI и т.д.).
        actions: []
        elementId: null
        colors: bg-neutralAlt-fg-dark
        styles:
        ...
        tagline: ''
      - title: AI-ready
        subtitle: готовность к будущему
        text: >
          Полное владение функционалом позволяет в любой момент добавить нужный
          расчет. Независимо от стороннего сервиса можно привлечь собственный
          персонал или разработчиков на аутсорсе.
        image:
