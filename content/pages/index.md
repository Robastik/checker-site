    ...
    items:
      - title: Надежность
        ...
        text: >
          ...
          подвержено минимальным рискам локальных инцидентов.
        image:
      ...
      - type: FeaturedItem
        ...
        text: >
          ...
          неограниченного количества людей из любой локации с любого устройства,
          как из браузера, так и со специальным ПО (Excel, Power BI и т.д.).
        actions: []
        elementId: null
        colors: bg-neutralAlt-fg-dark
        styles:
