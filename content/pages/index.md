    ...
    items:
      ...
      - type: FeaturedItem
        ...
        text: >
          ...
          достоверности. В любое время можете разработать новую таблицу и
          включить в нее данные из других систем. Данные уже готовы для
          использования ботами, автоматизациями, мониторингами, построенными
          также в экосистеме Гугл.
        actions: []
        elementId: null
        colors: bg-neutralAlt-fg-dark
        styles:
