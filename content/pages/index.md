...
sections:
  - type: GenericSection
    title:
      text: Выгрузка по API данных личного кабинета на маркетплейсе
      color: text-dark
      type: TitleBlock
  ...
  - type: FeaturedItemsSection
    ...
    items:
      ...
      - type: FeaturedItem
        ...
        text: >
          Хранилище данных гугл позволяет предоставлять доступ к сведениям в
          облаке за любой период времени с разделением ролей и прав доступа.
        actions: []
        elementId: null
        colors: bg-neutralAlt-fg-dark
        styles:
