  ...
  - type: FeaturedItemsSection
    ...
    items:
      - type: FeaturedItem
        ...
        text: >
          Хранилище данных гугл позволяет хранить, обрабатывать и предоставлять
      ...
      - title: Достоверность
        ...
        text: >
          ...
          основе показателя, его смысла, актуальности и обоснованности. Не
          требуется доверяться компетентности стороннего сервиса, можно
          полагаться только на своего проверенного финансиста.
        image:
