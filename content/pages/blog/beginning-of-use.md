...
**Панель управления** Чекера находится в гугл-таблице. На вкладках этой таблицы находится вся информация о выгрузках, их настройки и управление. Далее и везде эта таблица называется **чекер** - с маленькой буквы, чтобы отличать от названия сервиса **Чекер** - который всегда с заглавной. Сделайте копию этой таблицы. Если не знаете как копировать гугл-таблицу - посмотрите.
