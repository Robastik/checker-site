...
styles:
  self:
    flexDirection: col
---
После проверки всех настроек по чек-листу и [тестовой выгрузки](/blog/first-manual-unloading-bigquery/) для включения ежедневной выгрузки нужно только нажать одну кнопку.
