...
Названия кабинетов можно выбирать произвольно. Главное, чтобы названия были удобны для вас. Единственное ограничение для названий - не используйте пробелов и спецсимволов.

Названия кабинетов используются для маркировки данных. Многие таблицы включают в своем названии названия кабинетов для однозначного понимания какие данные в них находятся. На листе чекера **Журнал** названия кабинетов указывают на выгрузку по конкретному ключу API. 

В тех случаях, когда нет необходимости выгружать данные всех кабинетов (например, для списка складов или коэффициентов приемки) используется название **noCabinet**. Это название соответствует верхнему в списке ключу API или единственному ключу (когда в Мой склад ).
