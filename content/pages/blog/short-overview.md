...
Автоматическая выгрузка *Включение ежедневной автоматической выгрузки ЛК по API*

Контрольная панель чекера *Настройка, запуск и контроль резхультатов выгрузок*
